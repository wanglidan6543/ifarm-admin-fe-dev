  ...
  <Fragment>
    ...
    <div style={{ marginBottom: 16 }}>
      ...
      <a style={{ marginLeft: 16 }}>
        <span id="app.result.error.hint-btn1" defaultMessage="Thaw immediately" />
        <Icon type="right" />
      </a>
    </div>
    <div>
      ...
      />
      <a style={{ marginLeft: 16 }}>
        <span id="app.result.error.hint-btn2" defaultMessage="Upgrade immediately" />
        <Icon type="right" />
      </a>
    </div>
  </Fragment>
...
const actions = (
  <Button type="primary">
    <span id="app.result.error.btn-text" defaultMessage="Return to modify" />
  </Button>
);
...
export default () => (
  <PageHeaderWrapper>
    <Card bordered={false}>
      <Result
        type="error"
        title={tr('System', 'app.result.error.title')}
        description={tr('System', 'app.result.error.description')}
        extra={extra}
        actions={actions}
